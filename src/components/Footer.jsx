...
const Footer = () => {
  return (
    ...
    <a href={personalData.github} target='_blank' className="transition-all text-gray-400 hover:text-yellow-500 hover:scale-125 duration-300">
              <BsGithub size={22} />
    </a>
 <a href={personalData.linkedIn} target='_blank' className="transition-all text-gray-400 hover:text-blue-500 hover:scale-125 duration-300">
    ...
    <a href={personalData.email} target='_blank' className="transition-all text-gray-400 hover:text-red-500 hover:scale-125 duration-300">
              <FaEnvelope size={22} />
     </a>
    </div>
